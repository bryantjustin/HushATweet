...
#define FONT_SIZE_HUSH_TOTAL_LABEL 132.0f
#define FONT_SIZE_HUSH_TOTAL_SUBLABEL 18.0f
#define FONT_SIZE_SCORE_LABEL 72.0f
#define FONT_SIZE_SCORE_SUBLABEL 18.0f
